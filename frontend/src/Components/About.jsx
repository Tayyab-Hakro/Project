...
import cardimg2 from '../assets/Image.png'
...
<div className="flex flex-col justify-start mt-[240px]  md:flex-row justify-between items-center gap-6 md:gap-10 w-full">

  {/* LEFT SIDE */}
  <div className="w-full md:w-1/2 space-y-4 ">
<p className="font-['font-plusJakarta text-xl']font-normal italic text-[48px] leading-[150%] tracking-normal">
  AI Skin Anal
</p>
...
<div className="w-full md:w-1/2 flex justify-center  relative">
  ...
  {/* CARD ONE */}
 <div className="relative left-[240px] bottom-[46px]  w-[380px] h-[500px] rotate-[10deg] bg-white rounded-xl shadow-lg flex justify-center items-start">
